...

{
        ...
        throws ServiceException
	{
		...
		IDataUtil.put( pipelineCursor_1, "parentFlowElem", parentFlowElem );
        ...
        throws ServiceException
	{
		...
		IDataCursor pipelineCursor_1 = pipeline.getCursor();
		IDataUtil.put( pipelineCursor_1, "parentFlowElem", parentFlowElem );
		IDataUtil.put( pipelineCursor_1, "ifFlowElem", fs1 );
		IDataUtil.put( pipelineCursor_1, "elseFlowElem", fs2 );
		pipelineCursor_1.destroy();
        ...
        throws ServiceException
	{
		...
		IDataCursor pipelineCursor_1 = pipeline.getCursor();
		IDataUtil.put( pipelineCursor_1, "parentFlowElem", parentFlowElem );
		IDataUtil.put( pipelineCursor_1, "serviceFlowElem", fi );
		pipelineCursor_1.destroy();
        ...
        throws ServiceException
	{
		...
		IDataUtil.put( pipelineCursorOut, "parentFlowElem", parentFlowElem );
        ...
        throws ServiceException
	{
		...
		IDataCursor pipelineCursor_1 = pipeline.getCursor();
		IDataUtil.put( pipelineCursor_1, "parentFlowElem", parentFlowElem );
		IDataUtil.put( pipelineCursor_1, "caseFlowElemList", caseFlowElemList );
		pipelineCursor_1.destroy();
        ...
        throws ServiceException
	{
		...
		IDataCursor pipelineCursor_1 = pipeline.getCursor();
		Object flowRoot = new Object();
		IDataUtil.put( pipelineCursor_1, "flowRoot", fr );
		IDataUtil.put( pipelineCursor_1, "sig", rootFlowSvc.getSignature() );
		pipelineCursor_1.destroy();
        ...
        throws ServiceException
	{
		...
		// [i] recref:1:required InputList WxGenerate.docs:InputOutputSignature
		// [i] recref:0:required Output WxGenerate.docs:InputOutputSignature
		//   pipeline
				IDataCursor pipelineCursor = pipeline.getCursor();
				...
				if (!pkgExists){
					...
					NSName name = NSName.create("WxGenerate.flows:checkForPackage");
